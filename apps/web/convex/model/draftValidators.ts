...
export const consignmentDraftValidator = v.object({
  ...
  operationType: v.optional(v.literal("general")),
  consolidatedType: v.optional(v.string()),
  ...
  loading: v.optional(siteAppointmentDraftValidator),
  unloading: v.optional(siteAppointmentDraftValidator),
  cashConsignment: v.optional(v.boolean()),
  cashOnDelivery: v.optional(v.boolean()),
  declaredValue: v.optional(v.string()),
  consignmentValue: v.optional(v.string()),
  insurancePercent: v.optional(v.string()),
  policyHolder: v.optional(v.literal("transport_company")),
  ...
  natureOfCargo: v.optional(v.string()),
  merchandiseCode: v.optional(v.string()),
  packagingGroup: v.optional(v.string()),
  serviceOrderTransporter: v.optional(v.string()),
...
export const manifestDraftValidator = v.object({
  ...
  paymentAgencyCode: v.optional(v.string()),
  contractNumber: v.optional(v.string()),
  requiresTracking: v.optional(v.boolean()),
  observations: v.optional(v.string()),
