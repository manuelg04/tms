...
function fullInputs(): EmissionInputs {
  ...
  const remesa = {
    ...
    consignmentValue: "5000000",
    sender: order.sender,
    recipient: order.recipient,
    loading: { ...order.loading, agreedHours: "1" },
    unloading: { ...order.unloading, agreedHours: "2" },
    remissions: [{ remissionNumber: "REM-1", quantity: "1", description: "MAQUINARIA", weightTons: "20", packagingClass: "0" }],
    unitOfMeasure: "TN",
    packagingCode: "0",
    merchandiseCode: "009980",
    natureOfCargo: "1",
